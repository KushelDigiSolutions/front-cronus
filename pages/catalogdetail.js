              ...
              <div className="appsec1">
                ...
                <div className="appseleft">
                  ...
                  >
                    <SwiperSlide>
                      <div className="tes1wrap">
                        <img src='./images/triumph.svg' alt="" />
                      </div>
                    </SwiperSlide>
                    <SwiperSlide>
                      <div className="tes1wrap">
                  ...
                  <div className="swiper-button-prev">
                    <svg width="25" height="49" viewBox="0 0 25 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="25" height="49" rx="3" transform="matrix(-1 0 0 1 25 0)" fill="#CCCCCC" />
                      <path d="M11.8752 24.6967L16 20.5719L14.8215 19.3934L9.51815 24.6967L14.8215 30L16 28.8215L11.8752 24.6967Z" fill="white" />
                    </svg>

                  </div>
                  <div className="swiper-button-next">
                    <svg width="25" height="49" viewBox="0 0 25 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="25" height="49" rx="3" fill="#CCCCCC" />
                      <path d="M13.1248 24.6967L9 20.5719L10.1785 19.3934L15.4818 24.6967L10.1785 30L9 28.8215L13.1248 24.6967Z" fill="white" />
                    </svg>
                  </div>


                  <div className="moreImages">
                    <img src='./images/lik.svg' className="cursor-pointer" onClick={() => goToSlide(0)} alt="" />
                    <img src='./images/lik.svg' className="cursor-pointer" onClick={() => goToSlide(1)} alt="" />
                    <img src='./images/lik.svg' className="cursor-pointer" onClick={() => goToSlide(2)} alt="" />
                    {/* <img src='./images/lik.svg' className="cursor-pointer" onClick={() => goToSlide(3)} alt="" /> */}
                  </div>
                ...
                <div className="slideContent">
                  ...
                  <div className="slicons1">
                    ...
                    <div className="triu">
                    <h3>Triumph 24</h3>
                    <img src='./images/om.svg' className="starimg" alt="" />
                    </div>
